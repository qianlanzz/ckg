<template>
  <div>
    <el-input size="small" v-model="searchtext" placeholder="请输入内容" style="width: 300px"></el-input>
    <el-button size="small" @click="clickSearch">搜索</el-button>
...
export default {
  ...
  methods: {
    ...
    initGraph() {
      var _this = this;
      axios.get("/static/kgData22.json").then(function (response) {
    ...
    drawNode(nodes) {
      ...
      nodeEnter.on('mouseover', function (d) {
        ...
        d3.selectAll('.node').style('fill-opacity', 0.3)
        var relvantNodeIds = []
